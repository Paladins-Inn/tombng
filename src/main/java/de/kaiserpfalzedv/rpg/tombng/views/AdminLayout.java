...
package de.kaiserpfalzedv.rpg.tombng.views;
...
@RolesAllowed({"admin"})
@Slf4j
public class AdminLayout extends AbstractBaseLayout implements PermissionHolding {
    ...
    public void addMenu() {
        ...
        RouteConfiguration.forSessionScope()
                .getAvailableRoutes().stream()
                .filter(d -> FreeLayout.class.equals(d.getParentLayout()))
                .forEach(r -> menu.add(createTab(r)));
    }
}
